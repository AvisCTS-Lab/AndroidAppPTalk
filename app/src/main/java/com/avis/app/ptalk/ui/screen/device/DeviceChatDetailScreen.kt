...
fun DeviceChatDetailScreen(
    ...
    Column(Modifier.fillMaxSize()) {
        ...
        Column(
            ...
            Row(
                ...
                IconButton(onClick = { /* TODO: mark helpful */ }) {
                    Icon(Icons.Filled.SaveAlt, contentDescription = "Thumb up", tint = MaterialTheme.colorScheme.onSurfaceVariant)
                }
        ...
        com.avis.app.ptalk.ui.component.appbar.MainNavigationBar(navController)
    }
}
